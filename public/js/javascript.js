...
$(document).ready(function(){
  ...
  var makeFeedback = function() {
    ...
    svg.append("text")
        .attr("x", (width / 2))             
        .attr("y", 0 - (margin.top / 2) - 24)
        .attr("text-anchor", "middle")
        .style("font-size", "18px") 
        .text("Trial #" + trials + ": " + timestamps.length + " beats");
    ...
    svg.append("text")
        ...
        .attr("text-anchor", "middle")
        .style("font-size", "18px") 
        .text("Attempted: " + tempo + " beats per minute; Actual: " + (Math.round(100*timestamps.length * 60000 / sum,2)/100) + " beats per minute");
